(function() {
	...
	function d(a, b, d, e) {
		...
		n = [];
		if (m >= 0) f = c(l + Math.sqrt(m)) * Math.pow(Math.abs(l + Math.sqrt(m)), 1 / 3),
		g = c(l - Math.sqrt(m)) * Math.pow(Math.abs(l - Math.sqrt(m)), 1 / 3),
		n[0] = -h / 3 + (f + g),
		n[1] = -h / 3 - (f + g) / 2,
		n[2] = -h / 3 - (f + g) / 2,
		0 !== Math.abs(Math.sqrt(3) * (f - g) / 2) && (n[1] = -1, n[2] = -1);
		else {
	...
	j = function(a, b) {
		...
		d = 2 * c - 1,
		f = [], g = [], h = [], i = [], j = [[1, .6, .3, .1], [.4, .6, .6, .4], [.1, .3, .6, 1]], k = 0; c >= k; k++) f[k] = e.subtract(b[k], a);
		for (var k = 0; c - 1 >= k; k++) g[k] = e.subtract(b[k + 1], b[k]),
		g[k] = e.scale(g[k], 3);
		for (var l = 0; c - 1 >= l; l++) for (var m = 0; c >= m; m++) h[l] || (h[l] = []),
		h[l][m] = e.dotProduct(g[l], f[m]);
		for (k = 0; d >= k; k++) i[k] || (i[k] = []),
		i[k].y = 0,
		i[k].x = parseFloat(k) / d;
		for (var n = c,
		o = c - 1,
		p = 0; n + o >= p; p++) {
	...
	k = function(a, b, c, d) {
		...
		case 0:
			return 0;
		case 1:
			if (d >= f) return c[0] = (a[0].x + a[b].x) / 2,
			1;
			if (m(a, b)) return c[0] = n(a, b),
			1
		}
		o(a, b, .5, h, i),
		e = k(h, b, j, d + 1),
	...
	r = function(a, b) {
		for (var c = q(a.length - 1), d = 0, e = 0, f = 0; f < a.length; f++) d += a[f].x * c[f](b),
		e += a[f].y * c[f](b);
		return {
			x: d,
			y: e
	...
	u = function(a, b, c) {
		...
		for (var d = r(a, b), e = 0, f = b, g = c > 0 ? 1 : -1, h = null; e < Math.abs(c);) f += .005 * g,
		h = r(a, f),
		e += s(h, d),
		d = h;
		return {
	...
	v = function(a) {
		...
		if (t(a)) return 0;
		for (var c = r(a, 0), d = 0, e = 0, f = 1, g = null; 1 > e;) e += .005 * f,
		g = r(a, e),
		d += s(g, c),
		c = g;
		return console.log("length", (new Date).getTime() - b),
		d
	},
	w = function(a, b, c) {
	...
	C = function(a, b, c, d, e) {
		var f = [];
		return f.push.apply(f, B(a, b, a + c, b, e)),
	...
	D = function(a, b) {
		var c = [];
		return c.push.apply(c, B(a.x, a.y, a.x + a.w, a.y, b)),
...
function() {
	...
	p = function(a, b, c, d) {
		if (null == a.__taSmartClicks) {
			...
			h = function(b) {
				if (a.__tad && a.__tau && a.__tad[0] === a.__tau[0] && a.__tad[1] === a.__tau[1]) for (var c = 0; c < a.__taSmartClicks.length; c++) a.__taSmartClicks[c].apply(g(b), [b])
			};
			o(a, "mousedown", e, d),
			o(a, "mouseup", f, d),
			o(a, "click", h, d),
				...
				if (null == c.__taTapHandler) {
					...
					l = function(d) {
						for (var f = g(d), i = h(d, f, c, null != j), l = !1, m = 0; m < i.end; m++) {
							if (l) return;
							f = i.path[m];
							for (var o = 0; o < k.downSelectors.length; o++) if (null == k.downSelectors[o] || e(f, k.downSelectors[o], c)) {
								k.down = !0,
								setTimeout(n, a),
								setTimeout(p, b),
								l = !0;
						...
						if (k.down) {
							...
							for (var j in q) if (q.hasOwnProperty(j)) {
								...
								if (l.touches === i && (1 === l.taps || l.taps === k.taps)) for (var m = 0; m < k[j].length; m++) {
									...
									for (var n = 0; n < d.end; n++) if (b = d.path[n], null == k[j][m][1] || e(b, k[j][m][1], c)) {
										k[j][m][0].apply(b, [a]);
										break
									}
								}
	...
	t = function() {
		...
		return function(b, c, d, f) {
			if (!b.__tamee) {
				...
				var h = function(c) {
					var d = g(c); (null == f && d == b && !b.__tamee.over || e(d, f, b) && (null == d.__tamee || !d.__tamee.over)) && (s("mouseenter", c, b, d), d.__tamee = d.__tamee || {},
					d.__tamee.over = !0, a.push(d))
				},
				i = function(c) {
	...
	H = function(a, b, c) {
		...
		function() {
			var d = f(this);
			if (l(d, b, c), null != c.__tauid) if (d.removeEventListener) d.removeEventListener(b, c, !1),
	...
	d.Mottle = function(a) {
		...
		this.remove = function(a) {
			...
			function() {
				var a = f(this);
				if (a.__ta) for (var b in a.__ta) if (a.__ta.hasOwnProperty(b)) for (var c in a.__ta[b]) a.__ta[b].hasOwnProperty(c) && H(a, b, a.__ta[b][c]);
...
function() {
	...
	i = function(a, b, c) {
		for (var d = null,
		e = b.getAttribute("katavorio-draggable"), f = null != e ? "[katavorio-draggable='" + e + "'] ": "", i = 0; i < a.length; i++) if (d = h(b, c, f + a[i].selector), null != d) {
			if (a[i].filter) {
	...
	F = function(a, b, c, d) {
		...
		if (b.selector) {
			...
			null == R && (R = "" + (new Date).getTime(), a.setAttribute("katavorio-draggable", R)),
			O.push(b)
		}
		...
		this.snap = function(a, b) {
			if (null != F) {
				...
				f = T(c, a, b, d, e);
				return this.params.setPosition(F, f),
				f
			}
		},
		...
		W("function" == typeof this.params.constrain ? this.params.constrain: this.params.constrain || this.params.containment),
			...
			if (!a.defaultPrevented) {
				...
				if (b && this.isEnabled() && this.canDrag()) {
					...
					if (d) {
						...
						if (G) if (F = N.cloneNode(!0), this.params.addClass(F, r.clonedDrag), F.setAttribute("id", null), F.style.position = "absolute", null != this.params.parent) {
							var g = this.params.getPosition(this.el);
							F.style.left = g[0] + "px",
							F.style.top = g[1] + "px",
							this.params.parent.appendChild(F)
						} else {
							var j = f(N);
						...
						A && z(a),
						q = o(a),
						F && F.parentNode && (y = [F.parentNode.scrollLeft, F.parentNode.scrollTop]),
		...
		this.moveListener = function(a) {
			if (q) {
				...
				if (q) {
					...
					F && F.parentNode && (d += F.parentNode.scrollLeft - y[0], e += F.parentNode.scrollTop - y[1]),
					d /= f,
					e /= f,
					this.moveBy(d, e, a),
		...
		this.off = function(a, b) {
			if (da[a]) {
				for (var c = [], d = 0; d < da[a].length; d++) da[a][d] !== b && c.push(da[a][d]);
				da[a] = c
			}
		};
		var ea = function(a, b) {
			var c = null;
			if (P && P[a]) c = P[a](b);
			else if (da[a]) for (var d = 0; d < da[a].length; d++) try {
				var e = da[a][d](b);
				null != e && (c = e)
			} catch(f) {}
			return c
		...
		this.mark = function(a) {
			s = this.params.getPosition(F),
			t = this.params.getPosition(F, !0),
			u = [t[0] - s[0], t[1] - s[1]],
			this.size = this.params.getSize(F),
			ba = h.getMatchingDroppables(this),
			x(ba, !0, !1, this),
			this.params.addClass(F, this.params.dragClass || c.drag);
			var b;
			b = this.params.getConstrainingRectangle ? this.params.getConstrainingRectangle(F) : this.params.getSize(F.parentNode),
			aa = {
				w: b[0],
				h: b[1]
			},
		...
		this.unmark = function(a, d) {
			if (x(ba, !1, !0, this), K && L(N, F) ? (fa = [F.offsetLeft - n, F.offsetTop - p], F.parentNode.removeChild(F), F = N) : fa = null, this.params.removeClass(F, this.params.dragClass || c.drag), ba.length = 0, K = !1, !d) {
				ca.length > 0 && fa && b.setPosition(N, fa),
				ca.sort(I);
		...
		this.moveBy = function(a, c, d) {
			...
			if (L(this.el, F)) if (e[0] !== f[0] || e[1] !== f[1]) {
				if (!K) {
					...
					Q ? (Q.appendChild(g), j = b.getPosition(N.parentNode, !0), m = b.getPosition(b.ghostProxyParent, !0), n = j[0] - m[0], p = j[1] - m[1]) : N.parentNode.appendChild(g),
					F = g,
					K = !0
				}
				f = e
		...
		this.params.handle ? _(this.params.handle, !1) : _(this.params.filter, this.params.filterExclude)
	},
	G = function(a, b, c, d) {
		...
		this.canDrop = this.params.canDrop ||
		function(a) {
			return ! 0
		},
		...
		this.setHover = function(a, b, c) { (b || null == this.el._katavorioDragHover || this.el._katavorioDragHover === a.el._katavorio) && (this.params[b ? "addClass": "removeClass"](this.el, this._hoverClass), this.el._katavorioDragHover = b ? a.el._katavorio: null, e !== b && this.params.events[b ? "over": "out"]({
				el: this.el,
				e: c,
				drag: a,
				drop: this
	...
	a.Katavorio = function(a) {
		...
		i = function(a, b) {
			y(a,
			function(a) {
				for (var c = 0; c < a.scopes.length; c++) b[a.scopes[c]] = b[a.scopes[c]] || [],
				b[a.scopes[c]].push(a)
			})
		},
		j = function(b, c) {
		...
		this.draggable = function(b, c) {
			...
			function(b) {
				if (b = J(b), null != b) if (null == b._katavorioDrag) {
					...
					a.addClass(b, e.selector ? m.delegatedDraggable: m.draggable)
		...
		this.markPosses = function(a) {
			a.posses && y(a.posses,
			function(b) {
				a.posseRoles[b] && C[b] && w(C[b].members,
				function(a) {
					a.mark()
				},
				a)
		...
		this.unmarkPosses = function(a, b) {
			a.posses && y(a.posses,
			function(c) {
				a.posseRoles[c] && C[c] && w(C[c].members,
				function(a) {
					a.unmark(b, !0)
				},
				a)
		...
		var v = function(a, b) {
			b.posses && y(b.posses,
			function(c) {
				b.posseRoles[c] && C[c] && w(C[c].members,
				function(b) {
					a(b)
				},
				b)
		...
		this.snapToGrid = function(a, b) {
			for (var c in this._dragsByScope) w(this._dragsByScope[c],
			function(c) {
				c.snap(a, b)
			})
		},
		...
		this.removeFromPosse = function(a, b) {
			...
			for (var d = 1; d < arguments.length; d++) b = arguments[d],
			y(a,
			function(a) {
...
function() {
	...
	function l(b, e, g, h) {
		...
		var n = k(b);
		for (j in e) if (null == n[j] || m[j]) n[j] = e[j];
	...
	function s(a, b, c) { - 1 === p(a, c) && a.push(b)
	}
	function t(a, b, c, d) {
		var e = a[b];
	...
	function w() {
		...
		return F[255 & a] + F[a >> 8 & 255] + F[a >> 16 & 255] + F[a >> 24 & 255] + "-" + F[255 & b] + F[b >> 8 & 255] + "-" + F[b >> 16 & 15 | 64] + F[b >> 24 & 255] + "-" + F[63 & c | 128] + F[c >> 8 & 255] + "-" + F[c >> 16 & 255] + F[c >> 24 & 255] + F[255 & d] + F[d >> 8 & 255] + F[d >> 16 & 255] + F[d >> 24 & 255]
	}
	function x(a) {
	...
	E.suggest = u,
	E.extend = v;
	for (var F = [], G = 0; 256 > G; G++) F[G] = (16 > G ? "0": "") + G.toString(16);
	E.uuid = w,
	E.fastTrim = x,
	E.each = y,
	E.map = z,
	...
	var H = function() {
		function a() {
			...
			this.bind = function(b, c, d) {
				...
				else if (null != b.length) for (var f = 0; f < b.length; f++) e(b[f]);
				return a
			},
				...
				if (this.tick) this.queue.unshift(arguments);
					...
					if (this.tick = !0, !this.eventsSuspended && this._listeners[a]) {
						...
						if (!this.shouldFireEvent || this.shouldFireEvent(a, b, c)) for (; ! f && d > e && g !== !1;) {
							...
							e++,
							(null == this._listeners || null == this._listeners[a]) && (f = !0)
						}
					}
					this.tick = !1,
					this._drain()
			...
			this.unbind = function(a, b) {
				if (0 === arguments.length) this._listeners = {};
					...
					if ("string" == typeof a) delete this._listeners[a];
						...
						var c = void 0;
						for (var d in a.__jsPlumb) c = a.__jsPlumb[d],
						r(this._listeners[c] || [], a)
					}
...
function() {
	...
	c.prototype = {
		...
		_maybeUpdateParentList: function(a) {
			...
			c = this.instance.getContainer(); null != b && b !== c;) {
	...
	var d = function(a, b, c, d) {
		...
		this.destroy = function() {
			a.off(b, "scroll", h),
			delete b._jsPlumbScrollHandler;
			for (var c = a.getSelector(b, ".jtk-managed"), d = a.getId(b), e = 0; e < c.length; e++) if (c[e]._jsPlumbProxies) {
...
function() {
	...
	i = function(a, c, d) {
		if (a.getDefaultType) {
			...
			h(f, g, "__default");
			for (var j = 0,
			k = a._jsPlumb.types.length; k > j; j++) {
				...
				if ("__default" !== l) {
					...
					if (null != m) {
						...
						o = [];
						"override" === m.mergeStrategy ? Array.prototype.push.apply(n, ["events", "overlays", "cssClass"]) : o.push("cssClass"),
						i = b.merge(i, m, o, n),
						h(f, m, l)
					}
				}
	...
	b.extend(a.jsPlumbUIComponent, b.EventGenerator, {
		...
		addType: function(a, b, c) {
			...
			if (null != d) {
				for (var f = 0,
				h = d.length; h > f; f++) this.hasType(d[f]) || (this._jsPlumb.types.push(d[f]), e = !0);
				e && i(this, b, c)
			}
		},
		removeType: function(a, b, c) {
			...
			if (null != d) {
				for (var h = 0,
				j = d.length; j > h; h++) e = f(d[h]) || e;
				e && i(this, b, c)
			}
		},
		clearTypes: function(a, b) {
			for (var c = this._jsPlumb.types.length,
			d = 0; c > d; d++) k(this, 0),
		...
		toggleType: function(a, b, c) {
			...
			if (null != d) {
				for (var e = 0,
				f = d.length; f > e; e++) {
					var h = this._jsPlumb.types.indexOf(d[e]); - 1 !== h ? (k(this, h), this._jsPlumb.types.splice(h, 1)) : this._jsPlumb.types.push(d[e])
				}
				i(this, b, c)
			}
		},
		...
		destroy: function(a) { (a || null == this.typeId) && (this.cleanupListeners(), this.clone = null, this._jsPlumb = null)
		},
		isHover: function() {
		...
		setHover: function(a, b, d) {
			if (this._jsPlumb && !this._jsPlumb.instance.currentlyDragging && !this._jsPlumb.instance.isHoverSuspended()) {
				...
				null != this.canvas && (null != this._jsPlumb.instance.hoverClass && this._jsPlumb.instance[e](this.canvas, this._jsPlumb.instance.hoverClass), null != this._jsPlumb.hoverClass && this._jsPlumb.instance[e](this.canvas, this._jsPlumb.hoverClass)),
	...
	n = a.jsPlumbInstance = function(d) {
		...
		this.unbindContainer = function() {
			if (null != p && q.length > 0) for (var a = 0; a < q.length; a++) f.off(p, q[a][0], q[a][1])
		},
		...
		f.importDefaults = function(a) {
			...
			return a.Container && f.setContainer(a.Container),
			f
		},
		f.restoreDefaults = function() {
			return f.Defaults = o.extend({},
			i),
			f
		};
		var r = null,
		...
		H = function(a, b, d, e) {
			if (!B && (a = f.getElement(a), null != a)) {
				...
				if (f.anchorManager.redraw(g, b, d, null, e), h) for (var j = 0; j < h.length; j++) f.anchorManager.redraw(h[j].getAttribute("id"), null, d, null, e, !0)
			}
		},
		I = function(a) {
			return v[a]
		...
		L = function(a, c) {
			...
			if (!d.type && d.sourceEndpoint && (d.type = d.sourceEndpoint.connectionType), d.sourceEndpoint && d.sourceEndpoint.connectorOverlays) {
				...
				for (var e = 0,
				g = d.sourceEndpoint.connectorOverlays.length; g > e; e++) d.overlays.push(d.sourceEndpoint.connectorOverlays[e])
			}
			d.sourceEndpoint && d.sourceEndpoint.scope && (d.scope = d.sourceEndpoint.scope),
			...
			i = function(a, b, c, e) {
				if (d[a] && !d[a].endpoint && !d[a + "Endpoint"] && !d.newConnection) {
					...
					if (g = g ? g[e] : null) {
						...
						g.uniqueEndpoint ? g.endpoint ? j.finalEndpoint = g.endpoint: (g.endpoint = j, j.setDeleteOnEmpty(!1)) : j.setDeleteOnEmpty(!0),
						0 === b && g.def.connectorOverlays && (d.overlays = d.overlays || [], Array.prototype.push.apply(d.overlays, g.def.connectorOverlays))
					}
				}
			};
		...
		M = function(a) {
			...
			a.id = "con_" + F();
			var c = new b(a);
			return c.isDetachable() && (c.endpoints[0].initDraggable("_jsPlumbSource"), c.endpoints[1].initDraggable("_jsPlumbTarget")),
			c
		},
		N = f.finaliseConnection = function(a, b, c, d) {
			if (b = b || {},
			a.suspendedEndpoint || t.push(a), a.pending = null, a.endpoints[0].isTemporarySource = !1, d !== !1 && f.anchorManager.newConnection(a), H(a.source), !b.doNotFireConnectionEvent && b.fireEvent !== !1) {
				var e = {
					connection: a,
					source: a.source,
					target: a.target,
		...
		T = function(a, c, d) {
			...
			return e && "undefined" !== e || (2 === arguments.length && void 0 !== arguments[1] ? e = c: (1 === arguments.length || 3 === arguments.length && !arguments[2]) && (e = "jsPlumb_" + g + "_" + F()), d || f.setAttribute(a, "id", e)),
			e
		};
		...
		this.checkCondition = function(a, c) {
			...
			if (d && d.length > 0) {
				...
				try {
					for (var h = 0,
					i = d.length; i > h; h++) e = e && d[h].apply(d[h], g)
				} catch(j) {
		...
		V = function(a, b, c, d) {
			...
			if (b.constructor === o.Endpoint) e = b,
			e.addConnection(a),
			b = e.element;
			else if (f = T(b), g = this[h.epDefs][f], f === a[h.elId]) e = null;
			else if (g) for (var l in g) {
			...
			return null != e && (j.detachFromConnection(a), a.endpoints[c] = e, a[h.el] = e.element, a[h.elId] = e.elementId, k[0 === c ? "newSourceId": "newTargetId"] = e.elementId, X(k), d || a.repaint()),
			k.element = b,
			k
		}.bind(this);
		...
		this.deleteEveryEndpoint = function() {
			...
			for (var b in u) {
				...
				e = c.length; e > d; d++) f.deleteEndpoint(c[d], !0)
			}
			u = {},
			w = {},
			v = {},
		...
		this.deleteConnection = function(a, c) {
			return null != a && (c = c || {},
			c.force || b.functionChain(!0, !1, [[a.endpoints[0], Y, [a]], [a.endpoints[1], Y, [a]], [a, Y, [a]], [f, $, [Z, a]]])) ? (a.setHover(!1), W(a, !a.pending && c.fireEvent !== !1, c.originalEvent), a.endpoints[0].detachFromConnection(a), a.endpoints[1].detachFromConnection(a), b.removeWithFunction(t,
			function(b) {
				return a.id === b.id
		...
		this.deleteEveryConnection = function(a) {
			...
			return f.batch(function() {
				for (var d = 0; b > d; d++) c += f.deleteConnection(t[0], a) ? 1 : 0
			}),
			c
		},
		this.deleteConnectionsForElement = function(a, b) {
			...
			d = u[c];
			if (d && d.length) for (var e = 0,
			g = d.length; g > e; e++) d[e].deleteEveryConnection(b);
			return f
		},
		...
		da = function(a, b) {
			...
			else if (a.length) for (var d = 0,
			e = a.length; e > d; d++) c.push(l(a[d]).id);
			else c.push(l(a).id);
			return c
		},
		ea = function(a, b, c) {
		...
		this.getConnections = function(a, b) {
			...
			for (var c = a.scope || f.getDefaultScope(), d = da(c, !0), e = da(a.source), g = da(a.target), h = !b && d.length > 1 ? {}: [], i = function(a, c) {
				if (!b && d.length > 1) {
					var e = h[a];
					null == e && (e = h[a] = []),
					e.push(c)
		...
		ha = function(a, b) {
			...
			for (c = 0, d = f.length; d > c; c++) e[f[c]] = ba(a, f[c], b);
			for (c = 0, d = g.length; d > c; c++) e[g[c]] = ca(a, g[c]);
			return e
		},
		ia = function(a) {
			var b = ha(a, ia);
			return o.extend(b, {
				...
				"delete": function() {
					for (var b = 0,
					c = a.length; c > b; b++) f.deleteConnection(a[b])
				},
		...
		ja = function(a) {
			...
			return o.extend(b, {
				...
				deleteEveryConnection: function() {
					for (var b = 0,
					c = a.length; c > b; b++) a[b].deleteEveryConnection()
				},
				"delete": function() {
					for (var b = 0,
					c = a.length; c > b; b++) f.deleteEndpoint(a[b])
				}
			})
		};
		this.select = function(a) {
			return a = a || {},
			a.scope = a.scope || "*",
			ia(a.connections || f.getConnections(a, !0))
		},
		...
		var pa = function(a, b, c, d, e) {
			for (var f = a.target || a.srcElement,
			g = !1,
			h = d.getSelector(b, c), i = 0; i < h.length; i++) if (h[i] === f) {
				g = !0;
				break
			}
			return e ? !g: g
		},
		qa = function(c, d, e, g, h) {
			var i = new j(d),
			...
			return e.scope = e.scope || d.scope || f.Defaults.Scope,
			e[l] = b.wrap(e[l], k, !0),
			e.rank = d.rank || 0,
		...
		this.makeTarget = function(b, c, d) {
			...
			h = function(b) {
				...
				var j = {
					def: a.jsPlumb.extend({},
					e),
					uniqueEndpoint: e.uniqueEndpoint,
					maxConnections: g,
					enabled: !0
				};
				e.createEndpoint && (j.uniqueEndpoint = !0, j.endpoint = f.addEndpoint(b, j.def), j.endpoint.setDeleteOnEmpty(!1)),
				c.def = j,
				this.targetEndpointDefinitions[d][i] = j,
				qa(c, e, h, e.isSource === !0, !0),
				c.el._katavorioDrop[c.el._katavorioDrop.length - 1].targetDef = j
			}.bind(this), i = b.length && b.constructor !== String ? b: [b], j = 0, k = i.length; k > j; j++) h(i[j]);
			return this
		},
		this.unmakeTarget = function(a, b) {
			var c = l(a);
			return f.destroyDroppable(c.el, "internal"),
		...
		this.makeSource = function(c, d, e) {
			...
			for (var j = g.maxConnections || -1,
			m = g.onMaxConnections,
			n = function(d) {
				var e = d.id,
				i = this.getElement(d.el);
				this.sourceEndpointDefinitions[e] = this.sourceEndpointDefinitions[e] || {},
				la(e);
				var l = {
					def: a.jsPlumb.extend({},
					g),
				...
				g.createEndpoint && (l.uniqueEndpoint = !0, l.endpoint = f.addEndpoint(c, l.def), l.endpoint.setDeleteOnEmpty(!1)),
				...
				var u = function(c) {
					if (3 !== c.which && 2 !== c.button) {
						e = this.getId(this.getElement(d.el));
						...
						if (l.enabled) {
							...
							r = {};
							a.jsPlumb.extend(r, l.def),
							r.isTemporarySource = !0,
							r.anchor = [q[0], q[1], 0, 0],
							r.dragOptions = p,
							l.def.scope && (r.scope = l.def.scope),
							s = this.addEndpoint(e, r),
							t = !0,
							s.setDeleteOnEmpty(!0),
							l.uniqueEndpoint && (l.endpoint ? s.finalEndpoint = l.endpoint: (l.endpoint = s, s.setDeleteOnEmpty(!1)));
							var u = function() {
								f.off(s.canvas, "mouseup", u),
								f.off(d.el, "mouseup", u),
								t && (t = !1, f.deleteEndpoint(s))
							};
							f.on(s.canvas, "mouseup", u),
							f.on(d.el, "mouseup", u);
							var v = {};
							...
							f.trigger(s.canvas, "mousedown", c, v),
							b.consume(c)
						}
					}
				}.bind(this);
				...
				l.trigger = u,
				g.filter && (b.isString(g.filter) || b.isFunction(g.filter)) && f.setDragFilter(d.el, g.filter);
				var v = a.jsPlumb.extend({},
				g.dropOptions || {});
				qa(d, g, v, !0, g.isTarget === !0)
			}.bind(this), o = c.length && c.constructor !== String ? c: [c], p = 0, q = o.length; q > p; p++) n(l(o[p]));
			return this
		},
		...
		this.setSourceScope = function(a, b, c) {
			sa(a, b, "sourceEndpointDefinitions", c),
			this.setDragScope(a, b)
		},
		this.setTargetScope = function(a, b, c) {
			sa(a, b, "targetEndpointDefinitions", c),
		...
		var ta = function(a, c, d, e, g) {
			...
			if (g = g || "default", c.length && !b.isString(c)) {
				h = [];
				for (var m = 0,
				n = c.length; n > m; m++) i = l(c[m]),
				k[i.id] && k[i.id][g] && (h[m] = k[i.id][g].enabled, j = e ? !h[m] : d, k[i.id][g].enabled = j, f[j ? "removeClass": "addClass"](i.el, "jtk-" + a + "-disabled"))
			} else {
				i = l(c);
				var o = i.id;
		...
		var va = function(a, b) {
			if ("object" == typeof a && a.length) for (var c = 0,
		...
		this.removeAllEndpoints = function(a, b, c) {
			...
			var d = function(a) {
				...
				if (delete u[h.id], b && h.el && 3 !== h.el.nodeType && 8 !== h.el.nodeType) for (e = 0, g = h.el.childNodes.length; g > e; e++) d(h.el.childNodes[e])
			};
			return d(a),
			this
		};
		...
		this.setId = function(a, c, d) {
			...
			!0);
			c = "" + c,
			d ? a = this.getElement(c) : (a = this.getElement(e), this.setAttribute(a, "id", c)),
			u[c] = u[e] || [];
			for (var h = 0,
			i = u[c].length; i > h; h++) u[c][h].setElementId(c),
			u[c][h].setReferenceElement(a);
			delete u[e],
			this.sourceEndpointDefinitions[c] = this.sourceEndpointDefinitions[e],
			delete this.sourceEndpointDefinitions[e],
			this.targetEndpointDefinitions[c] = this.targetEndpointDefinitions[e],
			...
			var k = function(b, d, e) {
				for (var f = 0,
				g = b.length; g > f; f++) b[f].endpoints[d].setElementId(c),
	...
	b.extend(a.jsPlumbInstance, b.EventGenerator, {
		...
		convertToFullOverlaySpec: function(a) {
			return b.isString(a) && (a = [a, {}]),
			a[1].id = a[1].id || b.uuid(),
			a
		},
		registerConnectionType: function(b, c) {
			if (this._connectionTypes[b] = a.jsPlumb.extend({},
			c), c.overlays) {
				for (var d = {},
				e = 0; e < c.overlays.length; e++) {
		...
		registerEndpointType: function(b, c) {
			if (this._endpointTypes[b] = a.jsPlumb.extend({},
			c), c.overlays) {
				for (var d = {},
				e = 0; e < c.overlays.length; e++) {
					var f = this.convertToFullOverlaySpec(c.overlays[e]);
		...
		proxyConnection: function(a, b, c, d, e, f) {
			...
			i = a.endpoints[b];
			a.proxies = a.proxies || [],
			g = a.proxies[b] ? a.proxies[b].ep: this.addEndpoint(c, {
				endpoint: e(a, b),
				anchor: f(a, b),
				parameters: {
					isProxyEndpoint: !0
			...
			0 === b ? this.anchorManager.sourceChanged(h, d, a, c) : (this.anchorManager.updateOtherEndpoint(a.endpoints[0].elementId, h, d, a), a.target = c, a.targetId = d),
		...
		unproxyConnection: function(a, b, c) {
			if (null != a._jsPlumb && null != a.proxies && null != a.proxies[b]) {
				...
				0 === b ? this.anchorManager.sourceChanged(c, e, a, d) : (this.anchorManager.updateOtherEndpoint(a.endpoints[0].elementId, c, e, a), a.target = d, a.targetId = e),
	...
	o.each = function(a, b) {
		if (null != a) if ("string" == typeof a) b(o.getElement(a));
		else if (null != a.length) for (var c = 0; c < a.length; c++) b(o.getElement(a[c]));
		else b(a)
	},
...
function() {
	...
	b.OverlayCapableJsPlumbUIComponent.applyType = function(a, b) {
		if (b.overlays) {
			...
			for (c in b.overlays) {
				...
				if (e) e.updateFrom(b.overlays[c][1]),
				d[b.overlays[c][1].id] = !0,
				e.reattach(a._jsPlumb.instance, a);
				else {
					var f = a.getCachedTypeItem("overlay", b.overlays[c][1].id);
					null != f ? (f.reattach(a._jsPlumb.instance, a), f.setVisible(!0), f.updateFrom(b.overlays[c][1]), a._jsPlumb.overlays[f.id] = f) : f = a.addOverlay(b.overlays[c], !0),
					d[f.id] = !0
				}
			}
	...
	c.extend(b.OverlayCapableJsPlumbUIComponent, a.jsPlumbUIComponent, {
		...
		cleanup: function(a) {
			for (var b in this._jsPlumb.overlays) this._jsPlumb.overlays[b].cleanup(a),
...
function() {
	...
	b.Endpoint = function(a) {
		...
		var o = function(a) {
			if (this.connections.length > 0) for (var b = 0; b < this.connections.length; b++) this.connections[b].setHover(a, !1);
		...
		this.detachFromConnection = function(a, b, c) {
			...
			b >= 0 && (this.connections.splice(b, 1), this[(this.connections.length > 0 ? "add": "remove") + "Class"](i.endpointConnectedClass), this[(this.isFull() ? "add": "remove") + "Class"](i.endpointFullClass)),
		...
		this.deleteEveryConnection = function(a) {
			for (var b = this.connections.length,
			c = 0; b > c; c++) i.deleteConnection(this.connections[0], a)
		},
		this.detachFrom = function(a, b, c) {
			...
			for (var f = 0,
			g = d.length; g > f; f++) i.deleteConnection(d[0]);
			return this
		},
		...
		this.setElement = function(d) {
			...
			f = this.elementId;
			return c.removeWithFunction(a.endpointsByElement[this.elementId],
			function(a) {
				return a.id === this.id
			}.bind(this)),
		...
		this.initDraggable = function() {
			if (!p && b.isDragSupported(this.element)) {
				...
				y = function(c) {
					...
					var d = !0;
					this.isEnabled() || (d = !1),
					null != m || this.isSource || this.isTemporarySource || (d = !1),
					!this.isSource || !this.isFull() || null != m && this.dragAllowedWhenFull || (d = !1),
					null == m || m.isDetachable(this) || (this.isFull() ? d = !1 : m = null);
					...
					if (l === !1 ? d = !1 : "object" == typeof l ? b.extend(l, g || {}) : l = g || {},
					d === !1) return i.stopDrag && i.stopDrag(this.canvas),
					q.stopDrag(),
					!1;
					...
					w.isFloating = !0,
					this._jsPlumb.floatingEndpoint = f(this.getPaintStyle(), w, u, this.canvas, h.element, i, k, this.scope);
					var x = this._jsPlumb.floatingEndpoint.anchor;
					if (null == m) this.setHover(!1, !1),
					m = j({
						sourceEndpoint: this,
					...
					i.anchorManager.newConnection(m);
						...
						i.fire("connectionDrag", m),
						0 === y ? (o = [m.source, m.sourceId, s, z], i.anchorManager.sourceChanged(m.endpoints[y].elementId, h.id, m, h.element)) : (o = [m.target, m.targetId, s, z], m.target = h.element, m.targetId = h.id, i.anchorManager.updateOtherEndpoint(m.sourceId, m.endpoints[y].elementId, m.targetId, m)),
					...
					i.registerFloatingConnection(h, m, this._jsPlumb.floatingEndpoint),
				...
				z = function() {
					if (i.setConnectionBeingDragged(!1), m && null != m.endpoints) {
						...
						if (m.endpoints[0 === b ? 1 : 0].anchor.unlock(), m.removeClass(i.draggingClass), this._jsPlumb && (m.deleteConnectionNow || m.endpoints[b] === this._jsPlumb.floatingEndpoint) && n && m.suspendedEndpoint) {
							...
							m.isReattach() || m._forceReattach || m._forceDetach || !i.deleteConnection(m, {
								originalEvent: a
		...
		return function(b) {
			...
			if (null != i) {
				...
				if (!j || null != i.suspendedEndpoint._jsPlumb) {
					...
					if (null != k) {
						if (a.isRedrop(i, a)) return i._forceReattach = !0,
						i.setHover(!1),
						...
						e), !m && a.enabled()) {
							...
							if (n = n && a.isDropAllowed(i.sourceId, i.targetId, i.scope, i, k)) return o(n),
							!0;
							p()
						}
...
function() {
	...
	d = function(a, d, e, f, g) {
		if (b.Connectors[d] = b.Connectors[d] || {},
	...
	f = function(a, b, d, e) {
		...
		e ? delete b._jsPlumbConnections[a.id] : b._jsPlumbConnections[a.id] = !0, c.isEmpty(b._jsPlumbConnections) ? d.removeClass(b, d.connectedClass) : d.addClass(b, d.connectedClass))
	};
	b.Connection = function(a) {
		...
		b.OverlayCapableJsPlumbUIComponent.apply(this, arguments),
		a.sourceEndpoint ? (this.source = a.sourceEndpoint.getElement(), this.sourceId = a.sourceEndpoint.elementId) : this.sourceId = this._jsPlumb.instance.getId(this.source),
		a.targetEndpoint ? (this.target = a.targetEndpoint.getElement(), this.targetId = a.targetEndpoint.elementId) : this.targetId = this._jsPlumb.instance.getId(this.target),
		this.scope = a.scope,
		this.endpoints = [],
		this.endpointStyles = [];
		...
		null != a.deleteEndpointsOnEmpty && (this.endpoints[0].setDeleteOnEmpty(a.deleteEndpointsOnEmpty), this.endpoints[1].setDeleteOnEmpty(a.deleteEndpointsOnEmpty));
	...
	c.extend(b.Connection, b.OverlayCapableJsPlumbUIComponent, {
		applyType: function(a, c, d) {
			var e = null;
			null != a.connector && (e = this.getCachedTypeItem("connector", d.connector), null == e && (e = this.prepareConnector(a.connector, d.connector), this.cacheTypeItem("connector", e, d.connector)), this.setPreparedConnector(e)),
			...
			null != f && (this.endpoints[0].anchor = f[0], this.endpoints[1].anchor = f[1], this.endpoints[1].anchor.isDynamic && this._jsPlumb.instance.repaint(this.endpoints[1].elementId)),
			b.OverlayCapableJsPlumbUIComponent.applyType(this, a)
		},
		addClass: function(a, b) {
		...
		cleanup: function() {
			...
			this.source = null,
			this.target = null,
			null != this.connector && (this.connector.cleanup(!0), this.connector.destroy(!0)),
			this.connector = null
		},
		...
		prepareEndpoint: function(a, c, d, f, g, h, i, j, k) {
			...
			f.addConnection(d);
				...
				null == n.fill && null != h.paintStyle && (n.fill = h.paintStyle.stroke),
				null == n.outlineStroke && null != h.paintStyle && (n.outlineStroke = h.paintStyle.outlineStroke),
				null == n.outlineWidth && null != h.paintStyle && (n.outlineWidth = h.paintStyle.outlineWidth);
...
function() {
	...
	c.AnchorManager = function(a) {
		...
		q = function(a, b) {
			...
			h = function(b, c, d, g, h, i, j) {
				if (g.length > 0) for (var k = p(g, o[b]), m = "right" === b || "top" === b, n = l(b, c, d, k, h, i, m), q = function(a, b) {
				...
				r = 0; r < n.length; r++) {
					...
					t && q(s.endpoints[0], n[r]),
					u && q(s.endpoints[1], n[r])
				}
			};
		...
		this.newConnection = function(a) {
			...
			i = function(i, j, k, l, m) {
				d === e && k.isContinuous && (a._jsPlumb.instance.removeElement(f[1].canvas), h = !1),
				b.addToList(g, l, [m, j, k.constructor === c.DynamicAnchor])
			};
			i(0, f[0], f[0].anchor, e, a),
			h && i(1, f[1], f[1].anchor, d, a)
		};
		var r = function(a) { !
			function(a, c) {
				if (a) {
		...
		this.connectionDetached = function(a, c) {
			...
			d.floatingId && (j(d.floatingIndex, d.floatingEndpoint, d.floatingEndpoint.anchor, d.floatingId, d), r(d.floatingEndpoint)),
			r(d.endpoints[0]),
			r(d.endpoints[1]),
			c || (h.redraw(d.sourceId), d.targetId !== d.sourceId && h.redraw(d.targetId))
		},
		...
		this.deleteEndpoint = function(a) {
			b.removeWithFunction(d[a.elementId],
			function(b) {
				return b.id === a.id
			}),
			r(a)
		...
		var s = function(c, d, e, f, g, h, i, j, k, l, m, n) {
			...
			if (x) {
				var y = b.findWithFunction(x,
				function(a) {
					return a[4] === t
				});
				if ( - 1 !== y) for (x.splice(y, 1), o = 0; o < x.length; o++) p = x[o][1],
				b.addWithFunction(m, p,
				function(a) {
					return a.id === p.id
				}),
				b.addWithFunction(n, x[o][1].endpoints[i],
				function(a) {
					return a.id === p.endpoints[i].id
				}),
				b.addWithFunction(n, x[o][1].endpoints[u],
				function(a) {
					return a.id === p.endpoints[u].id
				})
			}
			for (o = 0; o < w.length; o++) p = w[o][1],
			1 === a.idx && w[o][3] === h && -1 === r && (r = o),
			b.addWithFunction(m, p,
			function(a) {
				return a.id === p.id
			}),
			b.addWithFunction(n, w[o][1].endpoints[i],
			function(a) {
				return a.id === p.endpoints[i].id
			}),
			b.addWithFunction(n, w[o][1].endpoints[u],
			function(a) {
				return a.id === p.endpoints[u].id
			});
			if ( - 1 !== q) w[q] = v;
		...
		this.updateOtherEndpoint = function(a, d, e, f) {
			var h = b.findWithFunction(g[a],
			function(a) {
				return a[0].id === f.id
			}),
			i = b.findWithFunction(g[d],
			function(a) {
				return a[0].id === f.id
			}); - 1 !== h && (g[a][h][0] = f, g[a][h][1] = f.endpoints[1], g[a][h][2] = f.endpoints[1].anchor.constructor === c.DynamicAnchor),
			i > -1 && (g[d].splice(i, 1), b.addToList(g, e, [f, f.endpoints[0], f.endpoints[0].anchor.constructor === c.DynamicAnchor])),
		...
		this.sourceChanged = function(a, d, e, f) {
			if (a !== d) {
				e.sourceId = d,
				e.source = f,
				b.removeWithFunction(g[a],
				function(a) {
					return a[0].id === e.id
				});
				var h = b.findWithFunction(g[e.targetId],
				function(a) {
					return a[0].id === e.id
				});
				h > -1 && (g[e.targetId][h][0] = e, g[e.targetId][h][1] = e.endpoints[0], g[e.targetId][h][2] = e.endpoints[0].anchor.constructor === c.DynamicAnchor),
				b.addToList(g, d, [e, e.endpoints[1], e.endpoints[1].anchor.constructor === c.DynamicAnchor]),
		...
		this.rehomeEndpoint = function(a, b, c) {
			...
			for (var k = 0; k < a.connections.length; k++) a.connections[k].sourceId === b ? h.sourceChanged(b, a.elementId, a.connections[k], a.element) : a.connections[k].targetId === b && (a.connections[k].targetId = a.elementId, a.connections[k].target = a.element, h.updateOtherEndpoint(a.connections[k].sourceId, b, a.elementId, a.connections[k]))
		},
			...
			if (!j.isSuspendDrawing()) {
				...
				w = 0; w < o.length; w++) {
					...
					if (A || B) {
						...
						G = j.getCachedData(y);
						z === y && (A || B) ? (s(i[y], -Math.PI / 2, 0, x, !1, z, 0, !1, "top", y, p, r), s(i[z], -Math.PI / 2, 0, x, !1, y, 1, !1, "top", z, p, r)) : (D || (D = this.calculateOrientation(y, z, G.o, F.o, x.endpoints[0].anchor, x.endpoints[1].anchor, x), v[C] = D), A && s(i[y], D.theta, 0, x, !1, z, 0, !1, D.a[0], y, p, r), B && s(i[z], D.theta2, -1, x, !0, y, 1, !0, D.a[1], z, p, r)),
						A && b.addWithFunction(t, y,
						function(a) {
							return a === y
						}),
						B && b.addWithFunction(t, z,
						function(a) {
							return a === z
						}),
						b.addWithFunction(p, x,
						function(a) {
							return a.id === x.id
						}),
						(A && 0 === E || B && 1 === E) && b.addWithFunction(r, x.endpoints[E],
						function(a) {
							return a.id === x.endpoints[E].id
						})
					}
				}
				for (w = 0; w < n.length; w++) 0 === n[w].connections.length && n[w].anchor.isContinuous && (i[a] || (i[a] = {
					top: [],
					right: [],
					bottom: [],
					left: []
				...
				!1, a, 0, !1, n[w].anchor.getDefaultFace(), a, p, r), b.addWithFunction(t, a,
				function(b) {
					return b === a
				}));
				...
				for (w = 0; w < o.length; w++) {
					...
					if (I.anchor.constructor === c.DynamicAnchor) {
						...
						b.addWithFunction(p, o[w][0],
						function(a) {
							return a.id === o[w][0].id
						});
						for (var J = 0; J < I.connections.length; J++) I.connections[J] !== o[w][0] && b.addWithFunction(p, I.connections[J],
						function(a) {
							return a.id === I.connections[J].id
						})
					} else b.addWithFunction(p, o[w][0],
					function(a) {
						return a.id === o[w][0].id
					})
				}
		...
		var t = function(a) {
			...
			this.isDynamic = !0,
			this.isContinuous = !0;
			for (var c = a.faces || ["top", "right", "bottom", "left"], d = !(a.clockwise === !1), g = {},
			h = {
				top: "bottom",
				right: "left",
				left: "right",
	...
	c.AnchorManager.prototype.calculateOrientation = function(a, b, c, d, e, f) {
		...
		return e.isContinuous && e.setCurrentFace(o),
	...
	c.Anchor = function(a) {
		...
		this.compute = function(a) {
			...
			d && d === this.timestamp ? this.lastReturnValue: (null != this.userDefinedLocation ? this.lastReturnValue = this.userDefinedLocation: this.lastReturnValue = [b[0] + this.x * c[0] + this.offsets[0], b[1] + this.y * c[1] + this.offsets[1], this.x, this.y], this.timestamp = d, this.lastReturnValue)
		},
		this.getCurrentLocation = function(a) {
			return a = a || {},
			null == this.lastReturnValue || null != a.timestamp && this.timestamp !== a.timestamp ? this.compute(a) : this.lastReturnValue
		},
		this.setPosition = function(a, b, c, d, f) { (!e || f) && (this.x = a, this.y = b, this.orientation = [c, d], this.lastReturnValue = null)
		}
	},
	...
	c.DynamicAnchor = function(a) {
		...
		this.setAnchorCoordinates = function(a) {
			var b = jsPlumbUtil.findWithFunction(this.anchors,
			function(b) {
...
function() {
	...
	b.Segments = {
		AbstractSegment: function(a) {
			...
			this.boxIntersection = function(a, b, c, d) {
				var e = [];
				return e.push.apply(e, this.lineIntersection(a, b, a + c, b)),
		...
		Straight: function(a) {
			...
			this.lineIntersection = function(a, b, c, f) {
				...
				n = [],
				p = k === 1 / 0 ? a: b - k * a;
				if (k !== l) if (k === 1 / 0 && 0 === l) o(a, g, h) && o(i, b, f) && (n = [a, i]);
	...
	b.Connectors.AbstractConnector = function(a) {
		...
		this.getPathData = function() {
			for (var a = "",
			c = 0; c < f.length; c++) a += b.SegmentRenderer.getPath(f[c], 0 === c),
			a += " ";
			return a
		},
		...
		s = function(a, b) {
			var c, d, e;
			if (b && (a = a > 0 ? a / g: (g + a) / g), 1 === a) c = f.length - 1,
			e = 1;
			else if (0 === a) e = 0,
			c = 0;
			else if (a >= .5) {
				for (c = 0, e = 0, d = h.length - 1; d > -1; d--) if (h[d][1] >= a && h[d][0] <= a) {
					c = d,
					e = (a - h[d][0]) / i[d];
					break
				}
			} else for (c = h.length - 1, e = 1, d = 0; d < h.length; d++) if (h[d][1] >= a) {
				c = d,
				e = (a - h[d][0]) / i[d];
				break
			}
		...
		this.setSegments = function(a) {
			p = [],
			g = 0;
			for (var b = 0; b < a.length; b++) p.push(a[b]),
			g += a[b].getLength()
		},
		this.getLength = function() {
			return g
		...
		this.draw = function(a, b) {
			...
			if (a.pointAlongPathFrom) {
				if (c.isString(this.loc) || this.loc > 1 || this.loc < 0) {
					...
					g = a.pointAlongPathFrom(m, l - this.direction * this.length / 2, !1),
				...
				} else e = a.pointAlongPathFrom(this.loc, this.direction * this.length / 2),
	...
	i = function(a) {
		...
		this.getElement = function() {
			if (null == this._jsPlumb.div) {
				...
				jsPlumb.addClass(c, this._jsPlumb.instance.overlayClass + " " + (this.cssClass ? this.cssClass: a.cssClass ? a.cssClass: "")),
		...
		this.draw = function(a, b, d) {
			...
			if (null != e && 2 === e.length) {
				...
				if (d) f = {
					...
					var g = this.loc,
					i = !1; (c.isString(this.loc) || this.loc < 0 || this.loc > 1) && (g = parseInt(this.loc, 10), i = !0),
					f = a.pointOnPath(g, i)
				} else {
	...
	c.extend(i, [b.jsPlumbUIComponent, g], {
		...
		paint: function(a, b) {
			this._jsPlumb.initialised || (this.getElement(), a.component.appendDisplayElement(this._jsPlumb.div), this._jsPlumb.initialised = !0, this.detached && this._jsPlumb.div.parentNode.removeChild(this._jsPlumb.div)),
...
function() {
	...
	z = function(a) {
		...
		function h(b) {
			...
			var i = function(c) {
				for (var d = 0; d < c.length; d++) if (!h[c[d].id]) {
					h[c[d].id] = !0;
		...
		this.addToGroup = function(b, c, d) {
			if (b = this.getGroup(b)) {
				...
				if (f !== b) {
					...
					null != f && (f.remove(c, !1, d, !1, b), n.updateConnectionsForGroup(f)),
					b.add(c, d);
					var i = function(a, c) {
						var d = 0 === c ? 1 : 0;
						a.each(function(a) {
							a.setVisible(!1),
							a.endpoints[d].element._jsPlumbGroup === b ? (a.endpoints[d].setVisible(!1), z(a, d, b)) : (a.endpoints[c].setVisible(!1), s(a, c, b))
						})
					};
				...
				if (a.collapsed) {
					var e = function(d, e) {
						for (var f = 0; f < d.length; f++) {
							var g = d[f];
							if (g.proxies) for (var h = 0; h < g.proxies.length; h++) if (null != g.proxies[h]) {
								var i = g.proxies[h].originalEp.element; (i === b || c(i, b)) && z(g, e, a)
							}
						}
					};
		...
		this.collapseGroup = function(b) {
			if (b = this.getGroup(b), null != b && !b.collapsed) {
				...
				if (g(b, !1), b.shouldProxy()) {
					...
					f(b.connections.source, 0),
					f(b.connections.target, 1)
				}
				b.collapsed = !0,
				a.removeClass(c, e),
				a.addClass(c, d),
		...
		this.refreshAllGroups = function() {
			for (var b in i) h(i[b]),
			a.dragManager.updateOffsets(a.getId(i[b].getEl()))
		}
	},
	A = function(c, d) {
		function e(a) {
		...
		this.remove = function(a, d, e, f, g) {
			...
			function(a) {
				if (a._jsPlumbGroup === t) {
					if (delete a._jsPlumbGroup, b.removeWithFunction(D,
					function(b) {
						return b === a
					}), d) try {
	...
	c.prototype.addGroup = function(a) {
		...
		null != b._groups[a.id]) throw new TypeError("cannot create Group [" + a.id + "]; a Group with that ID exists");
...
function() {
	...
	var d = function(a) {
		...
		this._computeBezier = function(a, b, d, e, f, g) {
			...
			l = d[0] < e[0] ? 0 : f,
			m = d[1] < e[1] ? 0 : g;
			h = this._findControlPoint([j, k], d, e, b.sourceEndpoint, b.targetEndpoint, a.so, a.to),
			i = this._findControlPoint([l, m], e, d, b.targetEndpoint, b.sourceEndpoint, a.to, a.so),
...
function() {
	...
	var z = function(a) {
		...
		this.paint = function(b, d, f) {
			if (null != b) {
				...
				i = [this.w, this.h];
				null != f && (f.xmin < 0 && (h[0] += f.xmin), f.ymin < 0 && (h[1] += f.ymin), i[0] = f.xmax + (f.xmin < 0 ? -f.xmin: 0), i[1] = f.ymax + (f.ymin < 0 ? -f.ymin: 0)),
				a.useDivWrapper ? (c.sizeElement(this.canvas, h[0], h[1], i[0], i[1]), h[0] = 0, h[1] = 0, g = u([0, 0])) : g = u([h[0], h[1]]),
		...
		d.renderer.paint = function(d, e, f) {
			...
			if (f.xmin < 0 && (i[0] = -f.xmin), f.ymin < 0 && (i[1] = -f.ymin), g.length > 0) {
				...
				if (d.outlineStroke) {
					...
					k.strokeWidth = n,
					null == c.bgPath ? (c.bgPath = t("path", j), b.addClass(c.bgPath, b.connectorOutlineClass), y(c.svg, c.bgPath, 0)) : s(c.bgPath, j),
					x(c.svg, c.bgPath, k, l, c)
				}
				null == c.path ? (c.path = t("path", j), y(c.svg, c.path, d.outlineStroke ? 1 : 0)) : s(c.path, j),
	...
	var A = b.SvgEndpoint = function(a) {
		...
		c.renderer.paint = function(a) {
			...
			null == this.node ? (this.node = this.makeNode(c), this.svg.appendChild(this.node)) : null != this.updateNode && this.updateNode(this.node),
...
function() {
	...
	g = function(a, c) {
		...
		}), g.setZoom(a.getZoom()), a[f] = g, a.bind("zoom", g.setZoom)),
		g
	},
	h = function(a) {
		var b = a.el._jsPlumbDragOptions,
		c = !0;
		return b.canDrag && (c = b.canDrag()),
		c && (this.setHoverSuspended(!0), this.select({
			source: a.el
		}).addClass(this.elementDraggingClass + " " + this.sourceElementDraggingClass, !0), this.select({
			target: a.el
		}).addClass(this.elementDraggingClass + " " + this.targetElementDraggingClass, !0), this.setConnectionBeingDragged(!0)),
		c
	},
	i = function(a) {
	...
	j = function(a) {
		for (var b, c = a.selection,
		d = function(a) {
			null != a[1] && (b = this.getUIPosition([{
				el: a[2].el,
				pos: [a[1].left, a[1].top]
			}]), this.draw(a[2].el, b)),
			null != a[0]._jsPlumbDragOptions && delete a[0]._jsPlumbDragOptions._dragging,
	...
	u = function(a, b, d) {
		...
		f = e.split(/\s+/),
		g = function(a, b) {
			for (var c = 0; c < b.length; c++) if (a) - 1 === f.indexOf(b[c]) && f.push(b[c]);
			else {
	...
	a.jsPlumb.extend(a.jsPlumbInstance.prototype, {
		...
		getDragManager: function() {
			return null == this.dragManager && (this.dragManager = new r(this)),
			this.dragManager
		},
		...
		getOffset: function(a, b, c) {
			...
			}.bind(this); null != e;) d.left += e.offsetLeft,
			d.top += e.offsetTop,
			f(e),
		...
		draggable: function(a, b) {
			var d;
			return a = c.isArray(a) || null != a.length && !c.isString(a) ? a: [a],
		...
		initDraggable: function(a, b, c) {
			g(this, c).draggable(a, b),
			a._jsPlumbDragOptions = b
		},
		destroyDraggable: function(a, b) {
			g(this, b).destroyDraggable(a),
			delete a._jsPlumbDragOptions
		},
		unbindDraggable: function(a, b, c, d) {
			g(this, d).destroyDraggable(a, b, c)
		},
		setDraggable: function(a, b) {
			return jsPlumb.each(a,
			function(a) {
		...
		toggleDraggable: function(a) {
			...
			function(a) {
				...
				return b = null == this._draggableStates[c] ? !1 : this._draggableStates[c],
				b = !b,
		...
		_initDraggableIfNecessary: function(a, b, d, e, f) {
			if (!jsPlumb.headless) {
				...
				if (g && jsPlumb.isDragSupported(a, this)) {
					...
					if (k = jsPlumb.extend({},
					k), jsPlumb.isAlreadyDraggable(a, this)) d.force && this.initDraggable(a, k);
					else {
		...
		doAnimate: function(a, c, d) {
			...
			p = setInterval(function() {
				...
				o++,
				o >= l && (window.clearInterval(p), null != d.complete && d.complete())
			},
			j)
		},
		...
		droppable: function(a, b) {
			...
			Array.prototype.slice.call(a).forEach(function(a) {
				d = this.info(a),
				d.el && this.initDroppable(d.el, b)
			}.bind(this)),
			this
		},
	...
	var v = function(a) {
		var b = function() { / complete | loaded | interactive / .test(document.readyState) && "undefined" != typeof document.body && null != document.body ? a() : setTimeout(b, 9)
		};
		b()
	};
	v(b.init)
